...
var reducer = function reducer() {
  ...
  switch (action.type) {
    ...
    case "DELETE_ITEM_FROM_CART":
      ...
      var existingDelItems = newState.itemsInCart;
      console.log("tempData item to be deleted : ", tempDelData);
      console.log("exsiting items in array : ", existingDelItems);
      var ind = existingDelItems.findIndex(function (x) {
        return x.item.name === action.payload.name;
      });
      console.log("tempData item to be deleted index : ", ind);
      existingDelItems.splice(ind, 1);
      console.log("exsiting items in array ----------- : ", existingDelItems);

      if (existingDelItems.some(function (existingDelItems) {
        return existingDelItems.item.name === action.payload.name;
      })) {} else {} // newState.cartNumber = action.payload;
...
//# sourceMappingURL=_app.js.63505e2f25b2d97a3434.hot-update.js.map