...
var reducer = function reducer() {
  ...
  switch (action.type) {
    ...
    case "ADD_ITEM_TO_CART":
      ...
      console.log("Current item name is exinting: ", existingItems ? existingItems.includes(action.payload.item.name) : "");

      if (existingItems) {
        for (var i = 0; i < existingItems.length - 1; i++) {
          if (existingItems[i].item.name == action.payload) {
...
//# sourceMappingURL=_app.js.83ecf33114c9b839f075.hot-update.js.map