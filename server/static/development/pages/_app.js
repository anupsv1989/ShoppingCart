...
/* harmony import */ var _style_commonStyle_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../style/commonStyle.scss */ "./style/commonStyle.scss");
/* harmony import */ var _style_commonStyle_scss__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_style_commonStyle_scss__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var _redux_createStore__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../redux/createStore */ "./redux/createStore.js");
...
/* harmony default export */ __webpack_exports__["default"] = (next_redux_wrapper__WEBPACK_IMPORTED_MODULE_4___default()(_redux_createStore__WEBPACK_IMPORTED_MODULE_7__["default"])(next_redux_saga__WEBPACK_IMPORTED_MODULE_5___default()(MyApp)));
...
/* harmony import */ var _redux_rootSaga__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../redux/rootSaga */ "./redux/rootSaga.js");
/* harmony import */ var _redux_rootReducer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../redux/rootReducer */ "./redux/rootReducer.js");
...
function configureStore(initialState = {}) {
  ...
  const store = Object(redux__WEBPACK_IMPORTED_MODULE_0__["createStore"])(_redux_rootReducer__WEBPACK_IMPORTED_MODULE_3__["default"], initialState, bindMiddleware([sagaMiddleware]));
  store.sagaTask = sagaMiddleware.run(_redux_rootSaga__WEBPACK_IMPORTED_MODULE_2__["default"]);
  return store;
}
...
function* onFetchItem() {
  ...
  try {
    const searchResult = yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["call"])(fetchListData); //Saga is suspended until the Promise returned by call

    if (searchResult !== undefined) {
      if (searchResult.items.length > 0) {
        yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["put"])(_action__WEBPACK_IMPORTED_MODULE_1__["default"].onFetchItemSuccess(searchResult)); //which instructs the middleware to dispatch a action
      } else {
        yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["put"])(_action__WEBPACK_IMPORTED_MODULE_1__["default"].onFetchItemError(errMsg));
      }
    }
  } catch (error) {
